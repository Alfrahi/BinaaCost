...
import CommentsDrawer from "@/shared/components/CommentsDrawer";
import { useProjectComments } from "@/features/projects/hooks/useProjectComments";
import { useScenarioManager } from "@/features/projects/hooks/useScenarioManager";
...
const LazyAnalyticsTab = React.lazy(() => import("../analytics/AnalyticsTab"));
const LazyReportsTab = React.lazy(() => import("../reports/ReportsTab"));
const LazyProjectVersionsTab = React.lazy(() => import("../versions/ProjectVersionsTab"));
