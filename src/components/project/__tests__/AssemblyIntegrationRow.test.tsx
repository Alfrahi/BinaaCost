...
import { AssemblyIntegrationRow } from "@/components/project/AssemblyIntegrationRow";
import { filterAssemblyItemsByType } from "@/lib/assemblyUtils";
...
vi.mock("@/hooks/useAssemblyItems", () => ({
  useAssemblyItems: () => ({
    itemsQuery: {
      data: [
