...
| Child items (`materials`, `labor_items`, etc.) | Owner, shared collaborator, or `super_admin` | Owner or editor | Owner, editor, or `super_admin` (`user_id` immutable) | Owner or `super_admin` |
